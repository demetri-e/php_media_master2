...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!isset($error_message)) {
        ...
        $mail->Username = "demetrioantonio@gmail.com";
        //Password to use for SMTP authentication
        $mail->Password = "cdnbhrswpjwgrznw";
        //It's important not to use the submitter's address as the from address as it's forgery,
        //which will cause your messages to fail SPF checks.
        //Use an address in your own domain as the from address, put the submitter's address in a reply-to
        $mail->setFrom('demetrioantonio@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('demetrioantonio@gmail.com', 'Demetri');
...
<div class="section page">
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            echo "<p>Thanks for the email! I&rsquo;ll check out your suggestion shortly!</p><br>
            <a href='index.php'>Back to Home</a>";
        } else {
            if (isset($error_message)) {
                echo '<p class="message">' . $error_message . '</p>';
            } else {
             echo  '<p>If you think there is something I&rsquo;m missing, please let me know. Complete the form to send me an email.</p>';
            }
        ?>
